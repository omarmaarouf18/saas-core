...
* **Negotiable Transport Pricing Architecture**: Transport/Rides category pricing model documented in [ADR-0006](docs/adr/0006-negotiable-transport-pricing.md) (`ba4c94a17437892534d6f88c02d517b0cc151270`). Defines single-shot take-it-or-leave-it fare proposals $[0.5 \times P_{\text{system}}, 1.5 \times P_{\text{system}}]$, 5-minute timeout stages, owner-governed vehicle/amenity multipliers, and deferred wallet escrow locking upon reaching `AgreedPrice`.
