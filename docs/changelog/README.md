...
*   [New Features](new-features.md) — 71 entries documenting complaint ticketing, KYB document uploads/reviews, location tracking, version gating, e-wallet payouts, UI capabilities, sequential cascade dispatch, and reviewer account directory/suspension.
...
*   [Bug Fixes](bug-fixes.md) — 86 entries detailing non-security fixes, consistency audits, race condition resolutions, error handling, and zero-commission cleanup.
*   [Documentation](documentation.md) — 40 entries for documentation updates, application map sync, and audit reports.
