...
*   [Security Fixes](security-fixes.md) — 130 entries detailing vulnerabilities, mTLS configuration, timing attacks, access controls (IDOR), rate limiters, and audit logging.
