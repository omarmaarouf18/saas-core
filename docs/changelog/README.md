...
*   [Bug Fixes](bug-fixes.md) — 87 entries detailing non-security fixes, consistency audits, race condition resolutions, error handling, and zero-commission cleanup.
