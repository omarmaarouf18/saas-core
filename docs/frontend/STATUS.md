...
* **Phase 15: Unified Account Settings & Role Home Redesign (ADR-0014)** — **[PLANNED, NOT STARTED]**
    *   *(a) Unified Settings / Account Action Center*: **[PLANNED, NOT STARTED]** Consolidates Dark/Light theme toggle, language selection, centralized Logout (eliminating 3 duplicated instances), and Customer Support ticket creation (`POST /chat/tickets`). Includes role-conditional sections: "Owner Configuration" for Owner role and "My Account" for User/Customer role (detailed content for both sections is explicitly deferred/TBD).
